...
<body>
  ...
  <div class="container mt-5">
    <h1 class="text-center">Detalhes do Local</h1>
    <div class="row mt-4">
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        ...
        <p>Descrição detalhada sobre o local alugado. Inclua informações como tamanho, comodidades, localização, preços, etc.</p>
        <ul>
          <li>Localização: Rua Exemplo, 123</li>
          <li>Tamanho: 100m²</li>
          <li>Comodidades: Wi-Fi, Ar-condicionado, Estacionamento</li>
          <li>Preço: R$ 1.000/mês</li>
        </ul>
